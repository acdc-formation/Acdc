          ...
          <?php if ( ! empty( $rows ) ) : ?>
            <?php foreach ( $rows as $row ) :
              ...
              $menu_items_top = array(
                ...
                'Version imprimable (HTML)' => $download_url,
